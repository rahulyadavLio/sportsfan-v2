import svgPaths from "./svg-fazfby0yok";
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_48_1196)" id="Icon">
  ...
  return (
    <div className="h-[69.75px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[0px] text-[rgba(255,255,255,0.9)] top-[0.5px] tracking-[-0.1504px] w-[242px]">
        ...
        <span className="leading-[22.75px] text-[14px]">{` since 2015. India is making steady progress in 100m.`}</span>
      </p>
    </div>
  );
}
...
function RecordDataContent() {
  return (
    <div className="content-stretch flex flex-col h-[1252px] items-start overflow-clip relative shrink-0 w-full" data-name="Record data content">
      <Container2 />
    </div>
  );
}
